...
def load(stream: IO[Any], Loader: Optional[Type] = FullLoader) -> Any: ...
...
class YAMLObject(metaclass=YAMLObjectMetaclass):
    ...
    @classmethod
    def from_yaml(cls: Type[T], loader: FullLoader, node: Node) -> T: ...


def add_representer(cls: Type[T], method: Callable[[Dumper, T], Node]) -> None: ...
def add_constructor(yaml_tag: str, method: Callable[[FullLoader, Node], T]) -> None: ...